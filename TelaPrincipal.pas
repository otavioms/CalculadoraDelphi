...
type
  ...
  private
    ...
    FNumero: double;    // Número armazenado para o cálculo
    FExpressao: char;   // Operador selecionado (+, -, *, /)
...
// Atualiza o edtResultado adicionando o número digitado
...
// Atualiza a lblResultado exibindo o número armazenado e o operador atual
...
// Retorna a soma do número armazenado com o número atual
function TForm1.Somar: double;
begin
  Result := FNumero + ObterResultado;
end;

// Retorna a subtração do número armazenado pelo número atual
function TForm1.Subtrair: double;
begin
  Result := FNumero - ObterResultado;
end;

// Retorna a multiplicação do número armazenado pelo número atual
function TForm1.Multiplicar: double;
begin
  Result := FNumero * ObterResultado;
end;

// Retorna a divisão do número armazenado pelo número atual (trata divisão por zero)
